...
function Account() {
  ...
  return (
    <section id="account" className="bg-[#FDFCF8] text-primary py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.9fr] gap-6 sm:gap-8 items-center">
          ...
          >
            <img src="/13.jpg" alt="Account benefits" className="w-full h-auto object-cover pt-40" />
          ...
          >
            ...
            <div className="absolute top-4 lg:-top-4 w-[200px] sm:w-[220px] md:w-[240px] lg:w-[280px] h-[380px] sm:h-[420px] md:h-[460px] lg:h-[540px] rounded-[30px] sm:rounded-[35px] md:rounded-[40px] flex items-center justify-center shadow-[0_20px_40px_rgba(205,64,244,0.955)]">
